...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        File productData = new File("/Users/pk/Desktop/Year 2/Term 1/PSP/SE_STORE7/src/Product data.txt");
        File categoryData = new File("/Users/pk/Desktop/Year 2/Term 1/PSP/SE_STORE7/src/Category data.txt");
        File memberData = new File("/Users/pk/Desktop/Year 2/Term 1/PSP/SE_STORE7/src/Member data.txt");
        ...
        do {
            ...
            switch (inputLogin){
                case "1":
                        ...
                        if (fileManage.checkCorrect(memberData, email, password)){ //ถ้าถูก
                            ...
                            if (fileManage.checkExpired()){ //ถ้าถูก
                                ...
                                if (fileManage.checkRole().equals("0")){
                                            ...
                                            case "3":
                                                ...
                                                do {
                                                    ...
                                                    if (editSelect.matches("\\d+") && Integer.parseInt(editSelect) >= 1 && Integer.parseInt(editSelect) <= fileManage.amountMember()) {
                                                            fileManage.showNameEdit(editSelect);
                                    ...
                                    }while (!inputSelectStaff.equals("4"));
                    ...
                    }while (countError != 3 && !inputSelect.equals("2") && !inputSelectStaff.equals("4"));//ถ้าใส่รหัสผิดไม่ถึง 3 ครั้ง และที่รับค่าเข้ามาไม่ใช่ 2 ให้วนลูปต่อ
